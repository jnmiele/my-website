...
const AboutMe = () => {
	return(
		<div id='description'>
			...
			<p>
				I was too young to identify this passion when choosing my college career and instead, majored in Marketing.
				Just three days before graduation I started my first full-time role as an Account Executive at UPS.
				While at UPS I served almost as a business consultant for the accounts I handled (around 1000 as an Account Executive, around 20 as a Senior Account Executive).
			...
			<p>
				...
				I had been surrounded by a few programmers who were just LOVING every minute of what they did and I may have them to thank for prompting me to start my journey.
